        ...
        <ScrollView  horizontal={true} pagingEnabled={true}>
         <View style={{
            ...
            <View >
                ...
                <Text style={{fontWeight: 'bold', paddingBottom: 4, color: 'rgb(25,25,255)',position: 'absolute', top:78,left:12}}>escalation 治療</Text>
            </View> 
            ...
            <View style = {styles.example}>
                ...
                <Text style ={{ color: 'rgb(255,255,255)', paddingTop:2,fontSize:12}}>オーグメンチン 375mg + サワシリン 250mg  1日3回{"\n"}(± ジスロマック 2000mg 1回)</Text>
                <Text style={{fontWeight: 'bold', marginTop: 15, color: 'rgb(255,255,255)'}}>注射:</Text>
                <Text style ={{ color: 'rgb(255,255,255)', paddingTop:2,fontSize:12}}>ロセフィン 2g/日  or  ユナシン 1.5-3g  6時間毎 </Text>
                <Text　style = {{fontSize: 6, color: 'rgb(255,255,255)',textAlign:'right',position: 'absolute', top:135, right:14}}> 感染症プラチナマニュアル2018,  MEDSi</Text>
                <Text　style = {{fontSize: 6, color: 'rgb(255,255,255)',textAlign:'right',position: 'absolute', top:143, right:14}}> レジデントのための感染症マニュアル第3版,  医学書院</Text>  
            </View>
         ...
         <View style={{
           ...
           <Text style={{fontWeight: 'bold', paddingBottom: 4, color: 'rgb(25,25,255)',position: 'absolute', top:78,left:12}}>de-escalation  多剤治療</Text>
            ...
            <View style = {styles.guidline}>
                ...
                <Text style ={{ color: 'rgb(255,255,255)', paddingTop: 1,fontSize:12}}>第4世代セフェム系薬  (嫌気性菌感染疑いには、使用しない)</Text>
            ...
            <View style = {styles.example}>
                ...
                <Text style ={{ color: 'rgb(255,255,255)', paddingTop:4,fontSize:12}}> + クラビット 500mg/日   or   ゲンタシン 5mg/kg/日</Text>
